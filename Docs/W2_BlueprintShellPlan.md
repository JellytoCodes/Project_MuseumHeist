...
- **연결:** `DT_ItemData.WorldLootActorClass`, `DA_GameBalance.RareLootItemId`, `Item.Loot.RareArtifact`
...
- `DT_ItemData.WorldLootActorClass`와 `DT_UsableItemData.SpawnedActorClass`가 필요한 Blueprint child를 가리킨다.
