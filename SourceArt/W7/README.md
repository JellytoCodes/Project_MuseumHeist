...
The Editor import script places floor plans in `/Game/Assets/UI/Map` and status icons in `/Game/Assets/UI/Status`.

## Generated audio

All audio is 48 kHz, stereo, 16-bit PCM and is imported into `/Game/Assets/Audio/W7`.
