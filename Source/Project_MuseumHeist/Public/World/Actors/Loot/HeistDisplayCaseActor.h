 ...
 */
UCLASS(meta = (DeprecatedNode, DeprecationMessage = "Use AHeistPaintingDisplayCaseActor for painting exhibits."))
class PROJECT_MUSEUMHEIST_API AHeistDisplayCaseActor : public AHeistPaintingDisplayCaseActor
{
	GENERATED_BODY()
