...
MAPS = {
    "M01": {
        ...
        "guard_routes": [
            [(-5800, 2400), (-3400, 2800), (-1000, 2400), (1400, 3000), (3800, 2800), (6100, 2400), (6100, 4600), (3800, 4600), (-1000, 4600), (-5800, 4600)],
            [(-4200, -2500), (-3200, -3000), (-1000, -2400), (1400, -3000), (3800, -2900), (6100, -2400), (6100, -4600), (3800, -4600), (1400, -4600), (-3200, -4600)],
            [(-1600, -500), (-800, -1600), (800, -1600), (1600, -500), (1600, 500), (800, 1600), (-800, 1600), (-1600, 500)],
            [(6100, -2400), (6100, -1200), (6100, 1000), (6100, 2400), (6100, 4500), (3800, 3000), (3800, -3000)],
        ...
        "lasers": [
            ('HighValue', (5000, -3000, 120, 0), (4700, -3350, 0, 0)),
            ('09', (5000, 4500, 120, 0), (4700, 4150, 0, 0)),
        ],
    },
    "M02": {
        ...
        "loot_spawn_points": [
            ...
            ("Vault_01", "VaultFixed", -5600, 3600, 90, -90.0),
        ...
        "guard_routes": [
            [(-6100, -3200), (-6100, -2200), (-5800, -800), (-4500, 1600), (-5200, 3600), (-3000, 5000), (-1400, 4600), (2200, 5000), (5200, 3000), (5800, 1000), (4800, -1200), (5600, -3000), (3200, -5000), (600, -5000), (-1800, -5000), (-3400, -3500), (-4500, -2800)],
            [(-1800, -600), (-1800, 1000), (-1200, 2200), (0, 2400), (1400, 1600), (1400, 200), (0, -600)],
            [(5100, -2800), (3000, -2200), (5600, -200), (3500, 800), (5800, 2800), (3700, 4600)],
            [(-6100, -2800), (-6100, -1400), (-4600, 0), (-3400, 1200), (-5000, 2400), (-3800, 3800)],
        ...
        "lasers": [
            ('HighValue', (-5600, 3000, 120, 90), (-5300, 2700, 0, 0)),
            ('07', (2200, 4000, 120, 90), (1900, 3700, 0, 0)),
        ],
    },
    "M03": {
        ...
        "guard_routes": [
            [(-6600, 0), (-5200, -400), (-3600, 400), (-2400, -500), (-800, 400), (1000, -400), (2800, 400), (4200, -500), (6200, 0)],
            [(-6200, 3500), (-4200, 3600), (-3000, 1800), (-1300, 3500), (1200, 3500), (3000, 3600), (6500, 3500), (7200, 2200)],
            [(-6200, -3600), (-4200, -3600), (-2400, -1800), (-400, -3600), (2000, -3600), (3800, -3600), (5200, -2200)],
        ...
        "lasers": [
            ('HighValue', (6000, -2000, 120, 0), (5700, -2300, 0, 0)),
            ('08', (4400, -2800, 120, 90), (4200, -2450, 0, 0)),
            ('10', (5200, 2800, 120, 90), (4900, 2450, 0, 0)),
        ],
    },
}
...
class LevelBuilder:
    ...
    def wall_h(self, name, y, start_x, end_x, doors=(), windows=(), material_name=None):
        if not set(doors).issubset(range(start_x, end_x + 1, 800)):
            raise ValueError("Door is not on an authored wall module: " + name)
        index = 0
    ...
    def wall_v(self, name, x, start_y, end_y, doors=(), windows=(), material_name=None):
        if not set(doors).issubset(range(start_y, end_y + 1, 800)):
            raise ValueError("Door is not on an authored wall module: " + name)
        index = 0
    ...
    def configure_lasers(self, cases):
        ...
        for index, spec in enumerate(self.config["lasers"]):
            ...
            doorway_width = {"M01": 400.0, "M02": 350.0, "M03": 300.0}[self.code]
            barrier.set_actor_scale3d(vec((1.0, doorway_width / 300.0, 1.0)))
...
def add_m02_geometry(builder):
    ...
    screen_specs = (
        ("00A", -5200, -3550, 0, 1800), ("00B", -4900, -2600, 0, 1800),
...
def add_m03_geometry(builder):
    ...
    builder.wall_h("GlassLane", 2800, -6800, 6800, doors=(-4400, -1200, 2000, 5200), windows=tuple(range(-6800, 6801, 800)), material_name=None)
    builder.wall_h("BackstageLane", -2800, -6800, 6800, doors=(-5200, -2000, 1200, 4400, 6800), material_name=mat)
    ...
    builder.wall_v("SecurityWest", 5200, -4000, -2800, doors=(-3200,), material_name=mat)
    builder.wall_h("SecurityNorth", -4000, 5600, 7200, doors=(6400,), material_name=mat)
    builder.wall_v("DetentionDivider", 6400, -4000, -2800, doors=(-3200,), material_name=mat)
...
def build_selected_levels():
    gallery = runpy.run_path(str(Path(__file__).with_name("refine_museum_galleries.py")))
    for code in selected_level_codes:
        ...
        gallery["refine_gallery"](builder, cases)
